"""Differentiable geometric operations for geoIR.

This module implements fully differentiable versions of the core geometric
operations so that gradients correctly flow from the loss back into the encoder
parameters.  It follows the guidelines from ``DIFFERENTIABILITY_GUIDE.md`` to
avoid the gradient pitfalls identified during development.
"""
