...
Valid runs discovered: `0`

## Latest Backed Runs

No valid run artifacts found.

## Decision Gate

- No valid runs yet; decision gate is pending.

## Skipped Runs

These directories were ignored because they were missing a valid `config.json` + `beir_results.json` pair:
